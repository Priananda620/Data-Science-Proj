...
We use the ggplot function to plot the number of trips made in a day and dplyr to aggregate the data. From the analysis, we find that the number of trips are higher around 5pm to 6pm. 
...
We visualize the number of trips each month of the year. We found that based on the graph, most of the trips were made during the month of September.
